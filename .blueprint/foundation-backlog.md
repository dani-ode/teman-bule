...
| FND-03 | SQL unit-of-work, initial identity/reliability migrations, bootstrap mechanism, repository owner scope dan audit | FND-01–02; DEC-03, DEC-17 bagian foundation; `postgresql-schema.md`, `database-bootstrap.md` | Fresh/upgrade migration, seed rerun/conflict pada PostgreSQL; rollback transaksi, unique/composite FK, cross-owner rejection, immutable audit policy |
...
- FND-03 membuat schema identity/reliability dan mekanisme bootstrap idempoten (`bootstrap_runs`, manifest validation, preview/apply) sesuai DEC-17 dan `database-bootstrap.md`; seed fitur baru diterapkan saat migration slice tersedia. Tabel fitur lain ditambahkan pada slice pemiliknya, bukan stub.
